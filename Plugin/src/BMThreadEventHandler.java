 ...
 * @since 3.2
 */
public class BMThreadEventHandler extends DebugEventHandler {
	 ...
	 * @param viewer
	 */
	public BMThreadEventHandler(AbstractModelProxy proxy) {
		super(proxy);
	}
	...
	protected void handleSuspend(DebugEvent event) {
        ...
        System.out.println("handlesuspend "+extras);
	...
	protected boolean handlesEvent(DebugEvent event) {
		return event.getSource() instanceof BMThread;
	}
