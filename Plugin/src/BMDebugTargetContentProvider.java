 ...
 *     Pawel Piech (Wind River) - ported BM Virtual Machine to Java (Bug 261400)
 *******************************************************************************/
...
public class BMDebugTargetContentProvider extends ElementContentProvider {
    ...
    protected int getChildCount(Object element, IPresentationContext context, IViewerUpdate monitor) throws CoreException {
		BMThread thread = ((BMDebugTarget) element).getThread();
		if (thread != null) {
	...
	protected Object[] getChildren(Object parent, int index, int length, IPresentationContext context, IViewerUpdate monitor) throws CoreException {
		if (context.getId().equals(IDebugUIConstants.ID_DEBUG_VIEW)) {
			BMThread thread = ((BMDebugTarget) parent).getThread();
			if (thread != null) {
