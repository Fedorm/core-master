...
namespace Jint.Native
{
    ...
    public sealed class JsClr : JsObject
    {
        ...
        public static object ConvertParameter(JsInstance parameter)
        {
            ...
            switch (constructor.Name)
            {
                ...
                case "Object":
                    ...
                    return new ExternalArrayList(array);
                default:
                    return parameter;
            }
        }
        ...
        public static JsInstance ConvertParameterBack(IJintVisitor visitor, object parameter)
        {
            ...
            {
                if (parameter.GetType().IsArray || parameter is ExternalArrayList)
                {
                    JsArray jsArray = visitor.Global.ArrayClass.New();
                    int index = 0;

                    foreach (object value in (IEnumerable)parameter)
        ...
        class ExternalArrayList : ArrayList
        {
            public ExternalArrayList(ICollection c)
                : base(c)
            {
            }
        }
