...
namespace Jint
{
    ...
    public class ExecutionVisitor : IStatementVisitor, IJintVisitor, IDeserializationCallback
    {
        ...
        [NonSerialized]
        protected internal IEntityAccessor _entitiyAccessor;
        [NonSerialized]
        ...
        private IScriptEngineContext scriptEngineContext;

        public ExecutionVisitor(Options options, IScriptEngineContext context, JintEngine jintEngine)
        {
        ...
        public DebugInformation CreateDebugInformation(Statement statement)
        {
            ...
            info.ScriptEngine = (JintEngine)this.scriptEngineContext.GetContext();
            info.Module = this.scriptEngineContext.ModuleName;
        ...
        public void Visit(TryStatement statement)
        {
            ...
            catch (JsException jsException)
            {
                ...
                if (statement.Catch.Identifier != null)
                {
                    ...
                    Assign(new MemberExpression(new PropertyExpression(statement.Catch.Identifier), null),
                        jsException.Value);
                }
        ...
        private object CreateInstance(ConstructorInfo constructor, object[] parameters)
        {
            object result = constructor.Invoke(parameters);
            if (result is IScriptEngineAware)
                ((IScriptEngineAware)result).SetContext(scriptEngineContext.GetContext());
            return result;
        }
        ...
        public void Visit(NewExpression expression)
        {
            ...
            if (Result.IsClr && Result.Value is Type)
            {
                ...
                try
                {
                    Result = Global.WrapClr(CreateInstance(constructor, parameters)/*constructor.Invoke(parameters)*/);
                }
                finally
                {
                    //CodeAccessPermission.RevertPermitOnly();
            ...
            switch (expression.Type)
            {
                ...
                case BinaryExpressionType.Equal:
                    ...
                    else
                    {
                        ...
                        else if (left is JsClr && right is JsClr)
                        {
                            bool value = left.Value == null
                                ? right.Value == null
                                : left.Value.Equals(right.Value);
                            Result = Global.BooleanClass.New(value);
                        }
                        else
                        {
                            Result = JsBoolean.False;
                ...
                case BinaryExpressionType.NotEqual:
                    ...
                    else if (left == JsUndefined.Instance && right != JsUndefined.Instance || left == JsNull.Instance && right != JsNull.Instance)
                    {
                        Result = JsBoolean.True;
                    }
                    else if (left != JsUndefined.Instance && right == JsUndefined.Instance || left != JsNull.Instance && right == JsNull.Instance || right == null)
                    {
                        if (left is JsClr)
                            Result = left.Value != null ? JsBoolean.True : JsBoolean.False;
                        else
                            Result = JsBoolean.True;
                    }
                    else if (left == JsUndefined.Instance && right != JsUndefined.Instance || left == JsNull.Instance && right is JsClr)
                    {
                        if (right is JsClr)
                            Result = right.Value != null ? JsBoolean.True : JsBoolean.False;
                        else
                            Result = JsBoolean.True;
                    }
                    else
            ...
            if (temp.IsClr) // && ((JsValue)Result).Type == JsValueType.CLRObject)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            object value;
                            if (_entitiyAccessor.TryGetValue(temp.Value, Result.ToString(), out value))
                            {
                                Result = Global.WrapClr(value);
                                return;
                            }
                        }
        ...
        public void Visit(MethodCall methodCall)
        {
            ...
            if (Result.Class == JsClrMethodInfo.TYPEOF)
            {
                ...
                try
                {
                    ...
                    MethodInfo methodInfo = methodInvoker.Invoke(callTarget.Value, clrMethod.Value.ToString(), ref clrParameters, generics.ToArray());
        ...
        public void Visit(PropertyExpression expression)
        {
            ...
            if (CurrentScope.IsClr && CurrentScope.Value != null)
            {
                ...
                object value;
                if (_entitiyAccessor.TryGetValue(CurrentScope.Value, propertyName, out value))
                {
                    Result = Global.WrapClr(value);
                    return;
                }
