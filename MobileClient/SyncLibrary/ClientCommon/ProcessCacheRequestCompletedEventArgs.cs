...
namespace Microsoft.Synchronization.ClientServices
{
    ...
    /// </summary>
	public class ProcessCacheRequestCompletedEventArgs : EventArgs
    {
        public Guid Id;
        ...
        public ProcessCacheRequestCompletedEventArgs(Guid id, ChangeSetResponse response, Exception error, object state)
        {
