...
namespace Microsoft.Synchronization.ClientServices
{
    ...
    public class CacheController : ICacheController
    {
        ...
        /// </summary>
        public ICacheControllerBehavior ControllerBehavior
        {
        ...
        /// </summary>
        public event Action<Exception> RefreshCompleted;
        ...
        void EnqueueUploadRequest()
        {
            ...
            try
            {
                ...
                if (changeSet == null || changeSet.Data == null || !changeSet.Data.Any())
                {
                ...
                else
                {
                    ...
                    CacheRequest request = new CacheRequest()
                    {
                        ...
                        Format = SerializationFormat.ODataAtom,
