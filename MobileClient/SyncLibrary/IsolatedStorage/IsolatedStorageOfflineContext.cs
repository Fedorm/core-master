...
namespace Microsoft.Synchronization.ClientServices.IsolatedStorage
{
    ...
    /// </summary>
    [Serializable]
    public class IsolatedStorageOfflineContext : OfflineSyncProvider, IOfflineContext
    {
        /// <summary>
        ...
        /// </summary>
        public event Action<Exception> LoadCompleted;
        ...
        public override void SaveChangeSet(ChangeSet changeSet)
        {
            ...
            _storageHandler.SaveDownloadedChanges(changeSet.Data, _isFirstSync);

            // Update in-memory representation.
            _cacheData.DownloadedChanges(changeSet.ServerBlob);
        ...
        private void CreateCacheController()
        {
            ...
            CacheControllerBehavior behavior = (CacheControllerBehavior)_cacheController.ControllerBehavior;
