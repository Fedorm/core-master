...
{
    public class GoogleMapBehavior : IWebMapBehavior
    {
        #region Page

        const string GoogleMapPage = @"
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div id=""map_canvas"" style=""width: 100%; height: 100%""></div>
        ...
        readonly List<string> _points = new List<string>();

        public string Page { get { return GoogleMapPage; } }
