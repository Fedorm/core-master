    ...
    public abstract class ViewProxy
    {
        ...
        public object Execute(string method, string[] parameters)
        {
            ...
            try
            {
                ...
                MethodInfo mi = GetType().GetMethod(string.Format("Do{0}", method));
                result = mi != null
                    ? mi.Invoke(this, preparedParameters)
                    : string.Format("Error: Method {0} is not supported", method);
        ...
        object[] PrepareParameters(string[] parameters)
        {
            ...
            if (parameters.Length > 0)
            {
                ...
                object obj = parameters[0] != "null" ? FindInValueStack(parameters[0]) : null;
        ...
        object FindInValueStack(string key)
        {
            ...
            string[] strings = key.Split(new[] { '.' }, StringSplitOptions.RemoveEmptyEntries);
        ...
        object GetValueByIndex(object collection, string index)
        {
            ...
            if (collection is Array)
            {
                ...
                if (int.TryParse(index, out id))
                    ...
                    throw new Exception(string.Format("Index {0} has to be an integer", index));
            }
