...
namespace Microsoft.Synchronization.Services
{
    ...
    internal static class SyncServiceConstants
    {
        ...
        internal const string SYNC_SERVICE_USERID = "userid";
        internal const string SYNC_SERVICE_USEREMAIL = "email";
        internal const string SYNC_SERVICE_RESOURCEVERSION = "resourceversion";
        internal const string SYNC_SERVICE_CONTENTLENGTH = "unzippedcontentlength";
