...
namespace Microsoft.Synchronization.Services
{
    ...
    internal sealed class RequestParser
    {
        ...
        private Dictionary<CommandParamType, object> GetCommandParameters(NameValueCollection queryStringCollection, String[] RelativeUriSegments)
        {
            ...
            string scopeName = GetScopeName(RelativeUriSegments);
        ...
        private RequestCommand GetRequestCommandType(string[] RelativeUriSegments)
        {
