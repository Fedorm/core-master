...
namespace Microsoft.Synchronization.Services
{
    ...
    /// </summary>
    public sealed class HttpContextServiceHost : MarshalByRefObject
    {
        ...
        private const string CONTENT_TYPE_APPLICATION_BM = "application/bitmobile";
        ...
        static readonly string[] _allowedAcceptsHeader = new[] { CONTENT_TYPE_ANY, CONTENT_TYPE_APPLICATION_ATOM, CONTENT_TYPE_APPLICATION_JSON, CONTENT_TYPE_APPLICATION_BM };
        ...
        public string RequestIfMatch { get; set; }
        public string RequestIfNoneMatch { get; set; }
        ...
        public string[] RelativeUriSegments { get; set; }
        ...
        internal SyncSerializationFormat GetRequestContentSerializationFormat()
        {
            ...
            if (contentTypeParts[0].Equals(CONTENT_TYPE_APPLICATION_BM, StringComparison.OrdinalIgnoreCase))
            {
                return SyncSerializationFormat.ODataBM;
            }
