...
namespace Microsoft.Synchronization.Services
{
    ...
    internal interface IRequestHandler
    {
        ...
        Stream ProcessRequestForMessage(Stream messageBody);
        ...
        [WebInvoke(UriTemplate = "ping", Method = "GET"), OperationContract]
        Stream Ping();

        [WebInvoke(UriTemplate = "logWebDav", Method = "POST"), OperationContract]
        Stream LogWebDav(Stream messageBody);
    }

    internal interface IRequestHandlerProxy
    {
        Stream ProcessRequest(HttpContextServiceHost ctx);
    }
}
