...
namespace Microsoft.Synchronization.Services
{
    ...
    /// </summary>
    internal sealed class HttpContextServiceHostOld
    {
        ...
        */
        ...
        internal HttpContextServiceHostOld() : this(null)
        {
        }

        internal HttpContextServiceHostOld(Stream messageBody)
        {
        ...
        internal void ValidateRequestHttpVerbAndSegments()
        {
            ...
            if (RelativeUriSegments.Length > 3)
            {
