...
namespace Sphorium.WebDAV.Server.Framework.BaseClasses
{
	...
	public abstract class DavMethodBase : IDavRequest
	{
        ...
        private string __solutionName;
        private object __userData;
        ...
        public string SolutionName
        {
            get
            {
                if(__solutionName == null)
                    __solutionName = ((AuthenticationArgs)__httpApplication.Context.Items["WebDAVModule_AuthArgs"]).Realm;
                return __solutionName;
            }  
        }
        ...
        public object UserData
        {
            ...
            {
                if(__userData == null)
                    __userData = __httpApplication.Context.Items["WebDAVModule_UserData"];
                return __userData;
            }  
        }
