...
namespace Microsoft.Synchronization.ClientServices
{
    ...
    public class CacheController
    {
		...
		Func<Uri, CacheControllerBehavior, AsyncWorkerManager, CacheRequestHandler> _cacheRequestFactory;
		...
		public void SetCacheRequestFactory(Func<Uri, CacheControllerBehavior, AsyncWorkerManager, CacheRequestHandler> cacheRequestFactory)
		{
        ...
        void RefreshWorker(AsyncWorkRequest asyncWorker, object[] inputParams)
        {
            ...
            try
            {
				...
				this._cacheRequestHandler = _cacheRequestFactory(_serviceUri, _controllerBehavior, _asyncWorkManager);
        ...
        void EnqueueUploadRequest()
        {
            ...
            try
            {
                ...
                {
                    // CreateInstance a SyncRequest out of this.
        ...
        void EnqueueDownloadRequest()
        {
            try
            {
                // CreateInstance a SyncRequest for download.
                CacheRequest request = new CacheRequest()
                {
                    Format = this.ControllerBehavior.SerializationFormat,
