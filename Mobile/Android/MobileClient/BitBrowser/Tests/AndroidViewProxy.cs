...
namespace BitMobile.Droid.Tests
{
    class AndroidViewProxy : ViewProxy
    {
        ...
        public AndroidViewProxy(ApplicationContext context, BaseScreen activity)
            : base(context)
        {
            _activity = activity;
        }
        ...
        {
            get { return (ApplicationContext)_context; }
        }
        ...
        public override bool DoSetText(object obj, string text)
        {
            ...
            if (control != null)
            {
                ...
                if (edit == null)
                    _context.InvokeOnMainThreadSync(
                        () => edit = (CustomEdit.EditTextNative)control.CreateView());
