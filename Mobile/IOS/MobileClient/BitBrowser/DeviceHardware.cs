...
namespace BitMobile.IOS.StyleSheet
{
	/// <summary>
	/// This code source is:
		...
		public static string Version {
			get {
				if (m_version == null) {
					...
					m_version = hardwareStr;
				}
				return m_version;
			}
		}

		public static float MillimetreToPixel (float size)
		{
			string version = Version;
		
			if (version == "iPhone1,1" || version == "iPhone1,2" || version == "iPhone2,1") {
				// 163
			}
			else if (version == "iPad1,1" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "") {

			}

//			if (version == "iPhone3,1" || version == "iPhone4,1" 
//				|| version == "iPod1,1" || version == "iPod2,1" || version == "iPod3,1" || version == "iPod4,1" 
//				|| version == "iPhone5,1" || version == "iPhone5,2" || version.Contains ("iPhone5")) {
//				// 326
//			}

			if (version == "iPad1,1" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "" || version == "") {
